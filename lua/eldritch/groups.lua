...
local function setup(configs)
  ...
  return {
    ...
    LspInlayHint = { fg = colors.fg_dark, bg = colors.bg_highlight },
    ...
    CodeActionNumber = { bg = colors.none, fg = colors.cyan },
    ...
    BlinkCmpKindCodeium = { fg = colors.teal, bg = colors.none },
    BlinkCmpKindCopilot = { fg = colors.teal, bg = colors.none },
    BlinkCmpKindDefault = { fg = colors.fg_dark, bg = colors.none },
    BlinkCmpKindSupermaven = { fg = colors.teal, bg = colors.none },
    BlinkCmpKindTabNine = { fg = colors.teal, bg = colors.none },
    ...
    BlinkCmpKindEvent = { fg = colors.bright_cyan },
    BlinkCmpKindOperator = { fg = colors.bright_purple },
    BlinkCmpKindTypeParameter = { fg = colors.pink },
    ...
    -- mini.indentscope
    MiniIndentscopeSymbol = { fg = colors.magenta2 },
    MiniIndentscopeSymbolOff = { fg = colors.magenta2 },
    ...
    DapUIType = { fg = colors.bright_purple },
    ...
    DapUISource = { fg = colors.bright_purple },
